...
import { useRestaurants, useCategories } from '../hooks/useData'
...
import type { Restaurant, Category } from '../hooks/useData'
...
// ProductsTab ~647 linii — tab default; descărcat la prima accesare
// (cascadează la ProductModal + ProductsCsvImport propriile lor lazy chunks)
