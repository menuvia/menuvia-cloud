...
// ─────────────────────────────────────────────────────────────────
// Modal complex pentru editare/creare produs.
// Extras dintr-un fișier DashboardPage.tsx de 4197 linii pentru a fi
// lazy-loaded — chunk-ul se descarcă DOAR când utilizatorul deschide
// "Adaugă produs" / "Editează produs".
//
// Conține: RecipeAddForm, ExtraForm, ProductModal (default export).
// Helper-urile vizuale (Modal/Inp/Sel/Toggle/btn/inp) sunt duplicate din
// DashboardPage pentru a păstra extragerea self-contained. Sunt câteva
// zeci de linii — cost acceptabil pentru a deferra ~1200 linii din main.
// ─────────────────────────────────────────────────────────────────

import { useState, useEffect } from 'react'
import React from 'react'
import { D, ALLERGENS, DIETARY_TAGS } from '../lib/constants'
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 13 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: '0.7rem', color: D.t3, marginBottom: 8, lineHeight: 1.5 }}>
            Opțional. Ajută clienții să găsească produse potrivite cu dieta lor (vegetarian, picant,
            etc).
          </div>
        ...
        <div>
          ...
          <div style={{ fontSize: '0.7rem', color: D.t3, marginBottom: 8, lineHeight: 1.5 }}>
            Bifează dacă produsul conține. Cerință legală (EU 1169/2011) — protejează clienții cu
            alergii.
          </div>
          <div
            style={{
